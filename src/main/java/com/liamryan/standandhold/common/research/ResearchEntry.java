...
public final class ResearchEntry {
    ...
    public ResearchEntry(String id, ResearchCategory category, String displayName, String description, int completionPointReward, List<String> requiredResearchIds) {
